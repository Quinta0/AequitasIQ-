...
def main():
    ...
    # Create charts for current year and next year
    income_pie_fig_current = make_pie_chart(df, current_year, 'Income')
    expense_pie_fig_current = make_pie_chart(df, current_year, 'Expense')
    income_pie_fig_next = make_pie_chart(df, next_year, 'Income')
    expense_pie_fig_next = make_pie_chart(df, next_year, 'Expense')
